...
def train(env, hyperparameters, actor_model, critic_model):
	"""
		...
		Parameters:
		6	env - the environment to train on
			hyperparameters - a dict of hyperparam67eters to use, defined in main
...
.
	...
	log_dir = '/home/nsyu/jimcode/PPO/implement/sensitive analysis lstm -64'
	write = SummaryWriter(log_dir)

	# excel write
	excel_write = 'sensitive analysis lstm -64' 
	file_path = "/home/nsyu/jimcode/PPO/train_data/data.xlsx"
...
def main(args):
	...
	if args.mode == 'train':
		...
		test_unm =  30			# number of sample test 
		asd_array = []
		aad_array = []
		mad_array = []
		std_ut_array = []
		...
		test(env=env, hyperparameters=hyperparameters, actor_model=args.actor_model, manytest=False, current_test_num=36)
